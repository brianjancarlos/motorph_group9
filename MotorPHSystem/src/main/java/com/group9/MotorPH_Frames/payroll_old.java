 ...
 * @author nativ
 */
public class payroll_old extends javax.swing.JFrame {

    Connection conn = null;
    ResultSet rs = null;
    PreparedStatement pst = null;
    Deductions_old deductions;
    ...
    public payroll_old() {
        ...
        deductions = new Deductions_old(conn);
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(payroll_old.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new payroll_old().setVisible(true);
            }
        });
    }
